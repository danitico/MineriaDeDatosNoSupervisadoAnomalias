...
claves.lof.ordenados <- lof.scores[lof.scores.order.index]
plot(claves.lof.ordenados, ylab="LOF scores")
```
...
```{r}
claves.outliers.lof <- lof.scores.order.index[1:11]
claves.outliers.lof.no.IQR <- setdiff(claves.outliers.lof, claves.outliers.IQR.en.alguna.columna)
nombres.outliers.lof.no.IQR <- nombres_filas(datos.num.norm, claves.outliers.lof.no.IQR)

biplot_2_colores(datos.num.norm, claves.outliers.lof.no.IQR)
```
...
## [1] 20 31 15 16 17  9
claves.outliers.lof
##  [1]  6 16 15 24  9 29  4 31 30 17  7
claves.outliers.lof.no.IQR
## [1]  6 24 29  4 30  7
nombres.outliers.lof.no.IQR
## [1] "Valiant"        "Camaro Z28"     "Ford Pantera L" "Hornet 4 Drive" "Ferrari Dino"  
## [6] "Duster 360"
```
